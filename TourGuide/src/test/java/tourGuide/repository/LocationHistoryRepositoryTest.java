...
public class LocationHistoryRepositoryTest {
  ...
  void findFirstByIdOrderByDateDescTest() {
    ...
    // Then
    assertThat(actualVisitedLocation.isPresent()).isTrue();
    assertThat(actualVisitedLocation.get()).isEqualTo(lastLocation);
  }
  ...
  void findFirstByIdOrderByDateDescWhenUserNotFoundTest() {
    ...
    // Then
    assertThat(actualVisitedLocation.isPresent()).isFalse();
  }
